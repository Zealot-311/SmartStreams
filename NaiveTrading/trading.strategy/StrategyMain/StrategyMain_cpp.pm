...
sub main::generate($$) {
   ...
   print '    */', "\n";
   print '	int batch_size = 40;', "\n";
   print '	', "\n";
   print '	float64 curr = tuple.getAttributeValue("price");', "\n";
   print '	', "\n";
   print '	ifstream ifs("history.txt");', "\n";
   print '	std::vector<float64> history;', "\n";
   print '	int now;', "\n";
   print '	', "\n";
   print '	ifs>>now;', "\n";
   print '	for(int i = 1; i < batch_size; i++) {', "\n";
   print '		ifs>>now;', "\n";
   print '		history.push_back(now);', "\n";
   print '	}', "\n";
   print '	', "\n";
   print '	history.push_back(curr);', "\n";
   print '	float64 diff = 0;', "\n";
   print '	', "\n";
   print '	for(int i = batch_size - 1; i > 1; i--){', "\n";
   print '		diff += i*(history[i] - history[i-1]);', "\n";
   print '	}', "\n";
   print '	', "\n";
   print '	ofstream ofs("history.txt");', "\n";
   print '	for(int i = 0; i < batch_size; i++) {', "\n";
   print '		ofs<<history[i];', "\n";
   print '	}', "\n";
   print '	', "\n";
   print '	int32 purchase = -1;', "\n";
   print '	if(diff > 0) {', "\n";
   print '		purchase = 1;', "\n";
   print '	}', "\n";
   print '	', "\n";
   ...
   print '	ValueHandle handle0 = otuple.getAttributeValue("strategy");', "\n";
   print '	', "\n";
   print '	int32 & strategy = handle0;', "\n";
   print '	strategy = purchase;', "\n";
