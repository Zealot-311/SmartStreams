...
#ifndef BEJWRMUWZLSJKTE4FABALANU_H_
#define BEJWRMUWZLSJKTE4FABALANU_H_
...
#define SELF BeJwrMUwzLSjKTE4FABALANU
...
public:
    ...
    SELF() : Tuple(), price_() {}
    SELF(const Self & ot) : Tuple(), price_(ot.price_) 
      { constructPayload(ot); }
    SELF(const price_type & _price) : Tuple(), price_(_price) { }
...
#undef SELF
#endif // BEJWRMUWZLSJKTE4FABALANU_H_ 
