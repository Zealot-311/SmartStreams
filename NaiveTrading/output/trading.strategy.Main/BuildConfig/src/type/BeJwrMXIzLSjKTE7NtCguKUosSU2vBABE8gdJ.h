...
#ifndef BEJWRMXIZLSJKTE7NTCGUKUOSSU2VBABE8GDJ_H_
#define BEJWRMXIZLSJKTE7NTCGUKUOSSU2VBABE8GDJ_H_
...
#define SELF BeJwrMXIzLSjKTE7NtCguKUosSU2vBABE8gdJ
...
public:
    ...
    SELF() : Tuple(), price_(), strategy_() {}
    SELF(const Self & ot) : Tuple(), price_(ot.price_), strategy_(ot.strategy_) 
      { constructPayload(ot); }
    SELF(const price_type & _price, const strategy_type & _strategy) : Tuple(), price_(_price), strategy_(_strategy) { }
    ...
    {
        size_t size = sizeof(SPL::float64)+sizeof(SPL::int32);
...
#undef SELF
#endif // BEJWRMXIZLSJKTE7NTCGUKUOSSU2VBABE8GDJ_H_ 
