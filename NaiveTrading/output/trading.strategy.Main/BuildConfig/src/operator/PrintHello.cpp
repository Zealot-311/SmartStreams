// eJyVkEFPg0AQhTN_1pfHMQms04UhbD5YSzdJojxuZwijsbmanIP31Iokaj80c5jB533tvgm8jUxkvyGn6QC1qsh_0QQDxNAosoUjJ6VBk_0Drx_1PV5y_1b4rt_1eFrOvz7uCCPiz7arPvNSX5RUuRPa9fhoGzqFnMhJbkJgb9lKcpB2GyNQCoxnUYVGPHRB2NjUoyVmlhNF3YYI_0t8x1aUYWhHks21SRTlRED1ln8xp6mpNP6x_10x2356xhDI2bkHece_1Ga7uAQQ8PwNgBZ7pDeHUOiN3tzDZGsF6BLKyWgJPwe357xx_1AeQbG2W
...
#define MY_BASE_OPERATOR PrintHello_Base
#define MY_OPERATOR PrintHello$OP
...
void MY_OPERATOR_SCOPE::MY_OPERATOR::process(Tuple const & tuple$, uint32_t port)
{
	...
	SPL::serializeWithPrecision(_f->writeTo(), iport$0.get_strategy()) << ',';
	SPL::serializeWithPrecision(_f->writeTo(), iport$0.get_revenue()) << '\n';
...
bool MY_BASE_OPERATOR::globalIniter() {
    instantiators_.insert(std::make_pair("PrintHello",&initer));
    return true;
}
