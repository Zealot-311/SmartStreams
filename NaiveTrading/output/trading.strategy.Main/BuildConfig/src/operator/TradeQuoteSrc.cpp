// eJydUctugzAQ1P5K1DM2KYoibjQpUgDTSpBDeokcWBKXhy1jQsjX12mVKr1WexqtZnZmtleNw0uuDGrfD0WDmRx0geACtTOHmeMQMykkLxiNmmX1PF427Fp7Jv78iLLsEiX5Tk3FJS0P6SZh3hAzxfLjNrgsXlmwd53T7I_1IpNMNfc6FN7BpoeJ1_0Db14zUvdJQvvflUdCwbt0G1d8doJW9kar00wjxRyN4T39e90aI7AgA5yRZ7cuoml_0x45_0SCdyQzGnnbr_1GMjVQtdoakXJwx17y0NFJyw6GTHd7CVTavVf_0jez8WGIsPg8FQI0IldcuNXa4tP_1wBFIr_0DKuhN7JNhC2QN99mKUgl9a_1h_1xYHLWjwwIiiRg13exRsAnyARrSPkPe10sI_0sGokNwsPKP0CFwyaB9




#include "./TradeQuoteSrc.h"
...
#define MY_BASE_OPERATOR TradeQuoteSrc_Base
#define MY_OPERATOR TradeQuoteSrc$OP
...
{
    SPL::BeJwrMSk2K8lMzk4tKjZJSSxJLTYpycxNdbNILM4uKMpMTgUAx6EMA_1 tuple$;
...
while(!getPE().getShutdownRequested()) {
    ...
    try {
            ...
            failedRead = false;
                    ...
                    SPL::readCSV<SPL::rstring,','>(fs, tuple$.get_ticker());
                    
                        fs >> SPL::skipSpaceTabs;
                         
                            sep = fs.peek();
                            if (sep != ',') {
                                DO_ERROR (SPL_APPLICATION_RUNTIME_FAILED_READ_CHAR (SPL::printableCharacter(','), SPL::printableCharacter(sep), _tupleNumber, "after reading the attribute ticker"));
                            }
                            fs >> sep;
                    ...
                    SPL::readCSV<SPL::rstring,','>(fs, tuple$.get_time());
                    ...
                    SPL::readCSV<SPL::float64,','>(fs, tuple$.get_askprice());
                    
                CHECK_ERROR (SPL_APPLICATION_RUNTIME_FAILED_READ_TUPLE("tuple<rstring ticker,rstring date,rstring time,float64 askprice>", _tupleNumber));
                CHECK_FAIL;
		    ...
		    if (eolSep == EOF) {
                        ...
                        DO_ERROR (SPL_APPLICATION_RUNTIME_FAILED_READ_CHAR ("\\n", SPL::printableCharacter(eolSep), _tupleNumber, "after reading the attribute askprice"));
		    } 
...
bool MY_BASE_OPERATOR::globalIniter() {
    instantiators_.insert(std::make_pair("TradeQuoteSrc",&initer));
    return true;
}
